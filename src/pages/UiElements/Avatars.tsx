...
export default function Avatars() {
  return (
    <>
      <PageMeta
        title="React.js Avatars Dashboard | CFR- React.js Admin Dashboard Template"
        description="This is React.js Avatars Dashboard page for CFR- React.js Tailwind CSS Admin Dashboard Template"
      />
