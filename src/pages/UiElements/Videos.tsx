...
export default function Videos() {
  return (
    <>
      <PageMeta
        title="React.js Videos Tabs | CFR- React.js Admin Dashboard Template"
        description="This is React.js Videos page for CFR- React.js Tailwind CSS Admin Dashboard Template"
      />
