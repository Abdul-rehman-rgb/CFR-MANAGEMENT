    ...
    <>
      <div className="grid grid-cols-1 gap-4 rounded-sm bg-white p-6 dark:bg-[#0D0D0D]">
        <div className="mb-3 flex flex-col gap-2 max-sm:flex-col md:flex-row md:items-center md:justify-between">
          <div>
            <HeadingTwo text="Stock Transfer" className="text-[#333333]" />
      ...
      <Modal
        ...
        isFullscreen={false}
      >
        <HeadingTwo text="Initiate Transfer" />
        <Form className="space-y-5" onSubmit={handleSubmit}>
          ...
          <div>
            ...
            <Dropdown
              ...
              onChange={(e) => handleChange("sourceWarehouse", e.target.value)}
          ...
          <div className="flex flex-col gap-2 sm:flex-row sm:justify-between">
            <Button
              ...
              className="border-[1px] w-full max-sm:w-full border-[#5D5FEF] hover:bg-[#5D5FEF] hover:text-white hover:border-[#5D5FEF] flex h-9 items-center gap-2 rounded-md px-4 sm:h-10 min-w-[120px] sm:min-w-[140px] transition-all"
            />
            <Button
              children="Request Stock Transfer"
              className="border-[1px] w-full max-sm:w-full border-[#5D5FEF] bg-[#5D5FEF] text-white hover:bg-white hover:text-[#5D5FEF] hover:border-[#5D5FEF] flex h-9 items-center gap-2 rounded-md px-4 sm:h-10 min-w-[140px] transition-all"
            />
          </div>
        </Form>
      </Modal>
