...
// import Icon1 from "../../../../public/images/task/icon1.png";
  ...
  return (
    <div className="fixed right-0 top-0 w-full md:w-[400px] h-screen bg-white dark:bg-[#0D0D0D] shadow-lg flex flex-col p-4 border-l border-gray-200 dark:border-gray-700 z-[100000]">
      ...
      <div className="mb-2 flex flex-row justify-between">
        <p className="text-[12px] text-[#8C8C8C] dark:text-gray-400 font-medium">Assignee</p>
      ...
      <div className="mb-2 flex flex-row justify-between">
        <p className="text-[12px] text-[#8C8C8C] dark:text-gray-400 font-medium">Priority</p>
      ...
      <div className="mb-4">
        <p className="text-[12px] text-[#8C8C8C] dark:text-gray-400 font-medium">Description</p>
        <textarea
