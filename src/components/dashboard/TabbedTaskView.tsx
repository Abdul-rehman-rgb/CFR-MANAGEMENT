...
const TabbedTaskView = () => {
  ...
  const allTasks = [
    ...
    { task: "Complete Vendor Contract Review", assignedTo: "Team B", priority: "Low", deadline: "Due today", status: "Completed" },
    { task: "Complete Vendor Contract Review", assignedTo: "Team B", priority: "Low", deadline: "Due today", status: "Completed" },
    { task: "Complete Vendor Contract Review", assignedTo: "Team B", priority: "Medium", deadline: "2 Days", status: "Completed" },
    { task: "Complete Vendor Contract Review", assignedTo: "Team B", priority: "Low", deadline: "4 Days", status: "Pending" },
    { task: "Complete Vendor Contract Review", assignedTo: "Team B", priority: "Low", deadline: "5 Days", status: "Pending" },
