...
export default function SignUpForm() {
  ...
  return (
    <div className="flex flex-col flex-1 w-full overflow-y-auto lg:w-1/2 no-scrollbar signup-container">
      {/*<div className="w-full flex justify-center mx-auto mb-5 sm:pt-10">
         <Link
          to="/"
